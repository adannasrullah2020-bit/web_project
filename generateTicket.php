...
if(isset($_POST['token']) && $_POST['token'] == $_SESSION['token']){
    ...
    unset($_SESSION['token']); // ek hi baar allow 

}else{
    die("Duplicate request blocked");
}
?>
		...
		<div class="col-sm-12 generateTicket">
			...
			<div class="commonHeader">
				...
				<div class="col-sm-3 text-right">
					...
					<a href="./"><i class="fa fa-globe" style="font-size: 2.5em; color: #251974;"></i></a>
			...
			<div class="importantInfo">
				...
				<div class="col-sm-10">
					...
					<div class="info">
						...
						<span class="strong">3.</span> It is mandatory to carry Government recognised photo identification (ID) along with your E-Ticket. This can include: Driving License, Passport, PAN Card, Voter ID Card or any other ID issued by the Government of Pakistan. For infant passengers, it is mandatory to carry the Date of Birth certificate.
