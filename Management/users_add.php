            ...
            <div class="col-12">
                <div class="dashboard-card">
                    <h4 class="card-header-title">
                        <i class="bi bi-people text-success"></i> Registered Users Management
                    </h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped align-middle border">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT UserID, FullName, Username, Phone, City, State, Date FROM users ORDER BY UserID DESC";
                                $result = mysqli_query($conn, $sql);

                                if (mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>";
                                        echo "<td><span class='badge bg-secondary'>#" . htmlspecialchars($row['UserID']) . "</span></td>";
