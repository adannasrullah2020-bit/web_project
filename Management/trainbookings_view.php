...
if(isset($_POST['search'])){
    ...
    if($searchID != ""){
        $search_query = "SELECT * FROM trainbookings WHERE bookingID = '$searchID'";
...
if(isset($_POST['update'])){
    ...
    if($b_id != ""){
        ...
        $update_query = "UPDATE `trainbookings` SET username='$b_user', date='$b_date', cancelled='$b_status', origin='$b_origin', destination='$b_dest', passengers='$b_pass' WHERE bookingID='$b_id'";
        ...
        if(mysqli_query($conn, $update_query)){
            if(mysqli_affected_rows($conn) > 0){
                ...
                $cancelled = $b_status; $origin = $b_origin; $destination = $b_dest; $passengers = $b_pass;
            } else {
...
if(isset($_POST['delete'])){
    $b_id = mysqli_real_escape_string($conn, $_POST['bookingID']);
    if($b_id != ""){
        $delete_query = "DELETE FROM `trainbookings` WHERE bookingID = '$b_id'";
...
<head>
    ...
    <title>Admin Panel | Manage Train Bookings</title>
    ...
    <div class="container-fluid px-4 pb-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                <div class="dashboard-card h-100">
                    <h4 class="card-header-title">
                        <i class="bi bi-pencil-square text-warning"></i> Manage Train Booking
                    </h4>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="cancelled" class="form-select fw-bold">
                                    <option value="Active" <?php if(strtolower($cancelled) == 'active' || strtolower($cancelled) == 'no') echo 'selected'; ?>>Active (Confirmed)</option>
                            ...
                            <div class="col-12 mt-4">
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" name="delete" class="btn btn-danger flex-grow-1 fw-bold" onclick="return confirm('Are you sure you want to permanently delete this booking?');">
            ...
            <div class="col-lg-8">
                <div class="dashboard-card h-100">
                    <h4 class="card-header-title">
                        <i class="bi bi-journal-text text-primary"></i> All Train Bookings Database
                    </h4>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped align-middle border">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT bookingID, username, date, cancelled, origin, destination, passengers FROM trainbookings ORDER BY bookingID DESC";
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    echo "<tr><td colspan='6' class='text-center text-muted py-4'>No train bookings found in the database.</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
